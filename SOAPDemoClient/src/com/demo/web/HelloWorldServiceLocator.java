...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.demo.web.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8089/SOAPDemo/services/HelloWorld";
    ...
    public com.demo.web.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.demo.web.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.demo.web.HelloWorldSoapBindingStub _stub = new com.demo.web.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.demo.web.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.demo.web.HelloWorldSoapBindingStub _stub = new com.demo.web.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://web.demo.com", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://web.demo.com", "HelloWorld"));
        }
