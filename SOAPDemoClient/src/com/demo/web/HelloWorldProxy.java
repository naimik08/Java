...
public class HelloWorldProxy implements com.demo.web.HelloWorld {
  private String _endpoint = null;
  private com.demo.web.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new com.demo.web.HelloWorldServiceLocator()).getHelloWorld();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public com.demo.web.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
