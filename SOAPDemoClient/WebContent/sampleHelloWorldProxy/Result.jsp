...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="com.demo.web.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        com.demo.web.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
